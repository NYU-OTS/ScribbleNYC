...
export default function FAQ() {
    ...
    return <div className='root'>
        ...
        <main key='2' class="main">
            <h2 class="faq__h2">What should I bring to Scribble NYC?</h2>
            <p class="faq__p">
            ...
            <h2 class="faq__h2">Who can attend?</h2>
            <p class="faq__p">
            ...
            <h2 class="faq__h2">How much does it cost?</h2>
            <p class="faq__p">
            ...
            <h2 class="faq__h2">How many people can be on a team for the design-a-thon?</h2>
            <p class="faq__p">
